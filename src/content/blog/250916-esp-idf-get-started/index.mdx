...
description: 'A complete beginner tutorial for setting up ESP-IDF on Windows, installing drivers, creating your first blinking LED project, and configuring VS Code for ESP32 development.'
date: 2025-09-16
